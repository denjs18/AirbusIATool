  ...
  templates: [
    {
      ...
      text: [
        ...
        "activities to be performed for the change requests listed in \u00a7x.x[2.1], which are",
        ...
        "performed, and provides in \u00a7x.x[9] the list of applicable rules and the",
    ...
    },
    {
      ...
      text: [
        ...
        "the severity definitions recalled in \u00a7x.x[3.1].",
      ].join("\n"),
